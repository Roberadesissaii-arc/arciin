...
const slides = [
  {
    title: (
      <>
        Claim your instance.
        <span className="block text-white/45">Keep it on your server.</span>
      </>
    ),
  ...
  },
  {
    title: (
      <>
        ...
        <span className="block text-white/45">Runs only on this machine.</span>
      </>
    ),
  ...
  },
  {
    title: (
      <>
        ...
        <span className="block text-white/45">First-run never repeats.</span>
      </>
    ),
