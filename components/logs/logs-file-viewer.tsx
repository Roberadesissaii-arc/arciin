        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <CardDescription className="text-zinc-600">
              Tail the last {TAIL_LINES} lines from API log files on disk. Refreshes automatically
        ...
        {filesQuery.isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border bg-zinc-50/50 px-6 py-12 text-center">
            ...
            <p className="max-w-md text-[13px] text-zinc-600">
              ...
              Restart the API if you just deployed this feature.
            </p>
          </div>
        ) : (
          <>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              {activeFile ? (
                <span className="text-xs text-zinc-500">
                  Updated {formatRelativeDate(activeFile.modifiedAt)} · {activeFile.source}
                </span>
              ) : null}
            </div>
            ...
            {tailQuery.isLoading ? (
              ...
              <div className="rounded-xl border border-red-500/25 bg-red-500/5 px-4 py-3 text-sm text-red-800">
              ...
              <pre
                className="max-h-[min(28rem,50vh)] overflow-auto rounded-xl border border-zinc-800 bg-zinc-950 p-4 font-mono text-[11px] leading-relaxed text-zinc-100"
                aria-label="Log tail"
              >
                {(tailQuery.data?.lines ?? []).length > 0
