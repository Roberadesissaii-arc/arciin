...
export function PersonalizationSubNav({
  ...
  return (
    <nav
      className="personalization-subnav relative overflow-hidden rounded-2xl border border-border/80 p-1.5 shadow-sm"
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 120% at 50% -20%, color-mix(in srgb, var(--arciin-accent, #ff4f12) 22%, transparent) 0%, transparent 55%), linear-gradient(180deg, color-mix(in srgb, var(--arciin-accent, #ff4f12) 6%, #fafafa) 0%, #ffffff 100%)",
        }}
      />
