...
export const ARCIIN_EXAMPLE_SCRIPTS = [
  ...
  "scripts/examples/lib/arciin_client.py",
  "scripts/examples/lib/wsl_hosts.sh",
  "scripts/examples/api/README.md",
  "scripts/examples/api/01_health_check.py",
  "scripts/examples/api/02_list_libraries.py",
  "scripts/examples/api/03_list_folders.py",
  "scripts/examples/api/04_create_folder.py",
  "scripts/examples/api/05_list_assets.py",
  "scripts/examples/api/06_upload_to_library.py",
  "scripts/examples/api/07_upload_auto_classify.py",
  "scripts/examples/api/08_list_app_databases.py",
  "scripts/examples/events/README.md",
  "scripts/examples/events/01_monitor_api_key.py",
] as const
