...
function SelectContent({
  ...
  /** dashboard = light popover (main app). dark = matches setup/auth screens. */
  surface?: "dashboard" | "dark"
}) {
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          surface === "dashboard" &&
            "dashboard-main bg-popover text-popover-foreground ring-foreground/10",
          surface === "dark" &&
            "border border-white/10 bg-zinc-950 text-zinc-100 shadow-xl ring-white/10 [&_[data-slot=select-item]]:text-zinc-200 [&_[data-slot=select-item]:focus]:bg-white/10 [&_[data-slot=select-item]:focus]:text-white [&_[data-slot=select-label]]:text-zinc-500",
          position === "popper" &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          ...
          className={cn(
            "max-h-[min(var(--radix-select-content-available-height),15rem)] overflow-y-auto p-1",
            position === "popper" &&
