    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Tablet + desktop: expanded gap always matches full sidebar width so
          // content shifts (never sits under/on top of the rail).
        )}
      />
      <div
        ...
        data-side={side}
        className={cn(
          // z-40 keeps the rail above page content while expanded on tablet.
      ...
      >
        <div
          ...
          className={cn(
            "flex size-full flex-col bg-sidebar text-sidebar-foreground shadow-none ring-0",
            // Rounded card look only for floating/inset — plain variant is a flush rail.
            "group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=inset]:rounded-xl group-data-[variant=inset]:border group-data-[variant=inset]:border-sidebar-border",
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 so tablet flex layout can shrink instead of overflowing under the rail
