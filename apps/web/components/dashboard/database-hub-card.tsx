...
export function DatabaseHubCard({ className }: { className?: string }) {
  ...
  return (
    <Card
      className={cn(
        "border-border bg-muted/30 shadow-none transition-colors hover:border-primary/30 hover:bg-muted/50",
        className,
      )}
    >
