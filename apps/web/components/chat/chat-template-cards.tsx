...
export const CHAT_TEMPLATES: ChatTemplate[] = [
  {
    ...
    linkText: "Start",
    imageSrc: "/assets/chat-templates/api.jpg?v=3",
    prompt:
  ...
  },
  {
    ...
    linkText: "Search",
    imageSrc: "/assets/chat-templates/find-files.jpg?v=3",
    prompt:
  ...
  },
  {
    ...
    linkText: "Organize",
    imageSrc: "/assets/chat-templates/organize.jpg?v=3",
    prompt:
  ...
  },
  {
    ...
    linkText: "Open",
    imageSrc: "/assets/chat-templates/documents.jpg?v=3",
    prompt:
