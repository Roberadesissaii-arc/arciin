...
export const CHAT_SLASH_COMMANDS: ChatSlashCommand[] = [
  ...
  },
  {
    ...
    name: "book",
    label: "Write a book",
    description: "Plan a book and write it chapter by chapter, continuing on its own",
    hint: "/book the history of the north sea fishing fleets",
    tools: [],
    // Only the planning turn goes through the composer. Every chapter after the
    // first is generated by the orchestrator, which owns its own prompts.
    expand: (args) => buildPlanPrompt(args),
  },
  {
    id: "modify",
    name: "modify",
